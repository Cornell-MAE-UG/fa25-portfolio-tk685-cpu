...
technologies: na
image: /assets/images/design_model.jpg
image: /assets/images/calculations.jpg
---
...
![Design of my choice]({{ "/assets/images/design_model.jpg"}}){: .inline-image-r style="width: 200px"}

As shown in the diagram, one pin connects the end of the actuator to the ground, another connects the end of the rod to the ground, and the final pin links the rod and the actuator, creating a stable triangular configuration.

![Calculation]({{ "/assets/images/calculations.jpg"}}){: .inline-image-r style="width: 200px"}

With this design, the mechanism achieved a maximum height of 40 cm and was capable of lifting a maximum weight of 5,668.5 N.
